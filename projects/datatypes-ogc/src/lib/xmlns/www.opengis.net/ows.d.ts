...
export interface ServiceProviderType extends _ServiceProviderType { constructor: { new(): ServiceProviderType }; }
export var ServiceProviderType: { new(): ServiceProviderType };
