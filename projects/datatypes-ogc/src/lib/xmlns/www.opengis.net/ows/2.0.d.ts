...
interface _AbstractReferenceBaseType extends BaseType {
	...
	arcrole?: xlink.arcroleType;
	href: xlink.hrefType;
	role?: xlink.roleType;
	show?: xlink.showType;
	title?: xlink.titleAttrType;
	type: string;
}
...
export interface ValuesReferenceType extends _ValuesReferenceType { constructor: { new(): ValuesReferenceType }; }
export var ValuesReferenceType: { new(): ValuesReferenceType };
