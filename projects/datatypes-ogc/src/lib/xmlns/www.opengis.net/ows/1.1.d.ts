...
// http://schemas.opengis.net/ows/1.1.0/owsContents.xsd
// http://schemas.opengis.net/ows/1.1.0/owsDataIdentification.xsd
// http://schemas.opengis.net/ows/1.1.0/owsDomainType.xsd
// http://schemas.opengis.net/ows/1.1.0/owsExceptionReport.xsd
// http://schemas.opengis.net/ows/1.1.0/owsGetCapabilities.xsd
// http://schemas.opengis.net/ows/1.1.0/owsGetResourceByID.xsd
// http://schemas.opengis.net/ows/1.1.0/owsInputOutputData.xsd
...
export interface AnyValueType extends _AnyValueType { constructor: { new(): AnyValueType }; }
export var AnyValueType: { new(): AnyValueType };
...
export interface ExceptionReportType extends _ExceptionReportType { constructor: { new(): ExceptionReportType }; }
export var ExceptionReportType: { new(): ExceptionReportType };
