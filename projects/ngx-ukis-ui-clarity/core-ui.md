# @dlr-eoc/ngx-ukis-ui-clarity (base-ui)
...
```
ng add @dlr-eoc/ngx-ukis-ui-clarity
```

- [add paths for library project in tsconfig.base.json](schematics/ng-add/index.ts#L273)

- [add styles and files (for base-ui)](schematics/ng-add/index.ts#L61)

- [adjust index.html and add favicon](schematics/ng-add/index.ts#L312)

- [add default components (base-ui) for the app and register all in the app module](schematics/ng-add/index.ts#L177)
...
## layout structure of the base-ui

The ngx-ukis-ui-clarity base-ui (created by the the schematics) is based on the [Clarity Application Layout](https://clarity.design/documentation/app-layout).
