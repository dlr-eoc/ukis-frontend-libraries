...
import { ProjectionSwitchComponent, MapNavigatorComponent, MousePositionComponent } from '@dlr-eoc/ngx-ukis-ui-clarity';
...
#### add the following to a route-view.component.ts
```
import { IProjDef } from '@dlr-eoc/ngx-ukis-ui-clarity'
```
```
